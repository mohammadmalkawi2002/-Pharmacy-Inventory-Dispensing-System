        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestoreAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PharmacistId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DosageInstructions = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dispenses_PrescriptionId_DispensedAt",
                table: "Dispenses",
                columns: new[] { "PrescriptionId", "DispensedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineBatches_MedicineId_ExpiryDate_ReceivedAt",
                table: "MedicineBatches",
                columns: new[] { "MedicineId", "ExpiryDate", "ReceivedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_Status_ValidTo",
                table: "Prescriptions",
                columns: new[] { "Status", "ValidTo" });

            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_MedicineBatchId_CreatedAtUtc",
                table: "StockMovements",
                columns: new[] { "MedicineBatchId", "CreatedAtUtc" });
        }
