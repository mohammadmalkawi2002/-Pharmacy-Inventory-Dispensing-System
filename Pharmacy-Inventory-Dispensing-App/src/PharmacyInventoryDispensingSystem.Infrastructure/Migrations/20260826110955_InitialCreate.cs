        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Medicines_QuantityInStock_NonNegative", "[QuantityInStock] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxRefill = table.Column<int>(type: "int", nullable: false),
                    RefillUsed = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PrescriptionItems_MaxRefill_NonNegative", "[MaxRefill] >= 0");
                    table.CheckConstraint("CK_PrescriptionItems_QuantityDispensed_NonNegative", "[QuantityDispensed] >= 0");
                    table.CheckConstraint("CK_PrescriptionItems_QuantityPrescribed_Positive", "[QuantityPrescribed] > 0");
                    table.CheckConstraint("CK_PrescriptionItems_RefillUsed_NonNegative", "[RefillUsed] >= 0");
                    table.ForeignKey(
